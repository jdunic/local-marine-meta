# Modifying the UnitSetManager2 code taken from https://github.com/cran/datamart/blob/904cb18c97d526d723d4667ff2f837bc5ff2096d/R/220_UnitSetManager2.R
# I was having massive difficulties dealing with '^2' and '^3' and '\u00b2' and 
# '\u00b3' respectively when trying to do unit conversions. This was fixed by 
# changing the original values that feed into the functions supplied to 
# unitsetmanager()
...
uset.volume <- function(...) { 
    ...
    siunit("m^3", value=1, extended=TRUE, dimension=3),
...
uset.area <- function(...) { 
    ret <- c(
    siunit("m^2", extended=TRUE, dimension=2), 
    ha=10^4, # Hektar
    a=100, #Ar
    b=10^(-28), # Barn
